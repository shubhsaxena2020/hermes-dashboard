...
import { SslPanel, GitPanel, FilesPanel, BackupPanel, DatabasesPanel, StatisticsPanel, LogsPanel, ProfilePanel, SubscriptionPanel, SecurityPanel } from '@/components/ServicePanels'
